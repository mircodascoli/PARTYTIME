  ...
  render() {
    ...
    return html`
     ...
     <div class="delivery">
      ...
      <checkout-button class="checkout-button" .total=${this.total} .name=${getSSNAME()} .email=${getSSEMAIL()} .products=${this.products}  @order-completed=${this._handleOrderCompleted}
      @order-failed=${this._handleOrderFailed}>Checkout</checkout-button>
         ${this.status === 'success'
