    ...
    return html`
      ...
      recipes.length === 0
        ? html`<p class="render-guard-p">
            No recipes saved yet. Start by creating some!
          </p>`
        : html`
            ...
            (item) => html`
              <li class="recipe-card">
                <div class="delete-recipe-container">
                  <three-dot-menu
                    @delete-recipe=${() => this.deleteRecipe(item._id)}
                  ></three-dot-menu>
                </div>
                ...
                <div class="recipe-header-serving-ingredients-container">
                  <div class="recipe-header">
                    <img
                      src="../../../img/imgCocktails/${item.name}.png"
                      alt="${item.name}"
                      class="recipe-preview-image"
                    />
                    <div class="name-desciption-container">
                      <p>
                        <span class="span-recipe-title">${item.name}</span> ×
                        ${item.amount}
                      </p>
                      <p class="recipe-preview-description">
                        ${item.description}
                      </p>
                    </div>
                  </div>
