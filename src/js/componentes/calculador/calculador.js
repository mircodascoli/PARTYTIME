...
export class Calculador extends LitElement{
    ...
    render(){
        ...
        <div id="inputscalculador">
         ...
         <label for="seleccionador">of: </label><select name="coktails" id="seleccionador" @change="${this.handleSelect}">
       ...
       <input id="range" type="range" min="200" max="2000" step="100" .value=${this.quantity} .disabled=${!this.selected} @input=${this.handleRange}/>
